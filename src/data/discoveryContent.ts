...
export const discoveryContent: DiscoveryItem[] = [
  ...
  { id: 'borrow-vs-lend', level: 'intermedio', category: 'error_comun', title: '"borrow" vs "lend"', explanation: '"borrow" = pedir prestado (tú recibes), "lend" = prestar (tú das).', example: 'Can I borrow your pen? / Can you lend me your pen?' },
  ...
  { id: 'vocab-home', level: 'principiante', category: 'vocabulario', title: 'Vocabulario: la casa', explanation: 'to tidy up (ordenar), landlord (dueño del arriendo), rent (arriendo).', example: 'I need to tidy up before the landlord comes to collect the rent.' },
  ...
  { id: 'vocab-health', level: 'intermedio', category: 'vocabulario', title: 'Vocabulario: salud', explanation: 'to recover (recuperarse), symptom (síntoma), appointment (cita u hora, como en "hora médica").', example: "I had a doctor's appointment because of a strange symptom." },
  { id: 'vocab-shopping', level: 'intermedio', category: 'vocabulario', title: 'Vocabulario: compras', explanation: 'refund (reembolso), receipt (boleta), to exchange (cambiar un producto).', example: 'I want to exchange this shirt, but I need the receipt.' },
